...
import com.tiger.item.pojo.SpecGroup;
import com.tiger.item.pojo.SpecParam;
import com.tiger.service.mapper.SpecGroupMapper;
import com.tiger.service.mapper.SpecParamMapper;
...
public class SpecService {
    ...
    public List<SpecGroup> querySpecGroupByCid(Long cid) {
        ...
        if (CollectionUtils.isEmpty(specGroupList)) {
            throw new TigerException(ExceptionEnum.SPEC_GROUP_NOT_FOUND);
        }
    ...
    public void saveSpecGroup(SpecGroup specGroup) {
        ...
        if (count != 1) {
            throw new TigerException(ExceptionEnum.SPEC_GROUP_CREATE_FAILED);
        }
    }
    ...
    public void deleteSpecGroup(Long id) {
        ...
        if (count != 1) {
            throw new TigerException(ExceptionEnum.DELETE_SPEC_GROUP_FAILED);
        }
    }
    ...
    public void updateSpecGroup(SpecGroup specGroup) {
        ...
        if (count != 1) {
            throw new TigerException(ExceptionEnum.UPDATE_SPEC_GROUP_FAILED);
        }
    }
    ...
    public List<SpecParam> querySpecParams(Long gid, Long cid, Boolean searching, Boolean generic) {
        ...
        if (CollectionUtils.isEmpty(specParamList)) {
            throw new TigerException(ExceptionEnum.SPEC_PARAM_NOT_FOUND);
        }
    ...
    public void saveSpecParam(SpecParam specParam) {
        ...
        if (count != 1) {
            throw new TigerException(ExceptionEnum.SPEC_PARAM_CREATE_FAILED);
        }
    }
    ...
    public void updateSpecParam(SpecParam specParam) {
        ...
        if (count != 1) {
            throw new TigerException(ExceptionEnum.UPDATE_SPEC_PARAM_FAILED);
        }
    }
    ...
    public void deleteSpecParam(Long id) {
        ...
        if (count != 1) {
            throw new TigerException(ExceptionEnum.DELETE_SPEC_PARAM_FAILED);
        }
    }
